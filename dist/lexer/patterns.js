...
export const tokenRegexMap = {
    ...
    THREE_D_REFERENCE: /^(?:'[^']+'|[A-Za-z_][A-Za-z0-9_]*)\s*:\s*(?:'[^']+'|[A-Za-z_][A-Za-z0-9_]*)!\$?[A-Za-z]{1,3}\$?\d+/,
    EXTERNAL_REFERENCE: /^\[[^\]]+\](?:'[^']+'|[A-Za-z_][A-Za-z0-9_]*)!\$?[A-Za-z]{1,3}\$?\d+/,
    RANGE: /^(?:'[^']+'|\[[^\]]+]|[A-Za-z_][A-Za-z0-9_]*)!\$?[A-Za-z]{1,3}\$?\d+:\$?[A-Za-z]{1,3}\$?\d+/,
    CELL: /^(?:'[^']+'|\[[^\]]+]|[A-Za-z_][A-Za-z0-9_]*)!\$?[A-Za-z]{1,3}\$?\d+/,
    CELL_OR_RANGE: /^(?:[A-Za-z_][A-Za-z0-9_]*!)?\$?[A-Za-z]{1,3}\$?\d+(?::\$?[A-Za-z]{1,3}\$?\d+)?/,
